...
procedure TFRMcadastrodeCarros.BTNexcluirClick(Sender: TObject);
begin
...
procedure TFRMcadastrodeCarros.BTNpesquisarClick(Sender: TObject);
begin
FRMpesquisaCArro.Show;
end;
